...
class single_instance(Frame):
    ...
    # - button: a button
    def __init__(self, master, name = '', input_method = 'menu', input_option = [], width = 0, init_value = None):
        ...
        self.index = 0
        self.width = width
        labelWidth = int(self.width*0.25)
        inputWidth = int(self.width*0.75)
        ...
        label = Label(self, text = self.name, width = labelWidth, anchor = 'w', justify = LEFT)
...
class configure_tab(Frame):
    ...
    def add_instance(self, name = '', method = 'entry', input_option = [], init_value = None):
        instance = single_instance(self, name, method, input_option, width = self.width, init_value = init_value)
